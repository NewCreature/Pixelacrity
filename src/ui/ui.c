...
void pa_resize_ui(PA_UI * uip)
{
	...
	separator_space = pa_get_theme_int(uip->theme, "separator_space", 8);
	separator_offset = pa_get_theme_int(uip->theme, "separator_offset", 8);
	separator_size = pa_get_theme_int(uip->theme, "separator_size", 2);
	...
	resize_element(uip->element[PA_UI_ELEMENT_TOOLBAR_FILE_SEPARATOR], pos_x, pos_y + separator_offset, separator_size, pos_vy - separator_offset * 2);
	...
	pos_x += pos_vx + separator_space;
	resize_element(uip->element[PA_UI_ELEMENT_TOOLBAR_UNDO_SEPARATOR], pos_x, pos_y + separator_offset, separator_size, pos_vy - separator_offset * 2);
	pos_x += separator_space;
	...
	pos_x += pos_vx + separator_space;
	resize_element(uip->element[PA_UI_ELEMENT_TOOLBAR_CLIPBOARD_SEPARATOR], pos_x, pos_y + separator_offset, separator_size, pos_vy - separator_offset * 2);
	pos_x += separator_space;
	...
	resize_element(uip->element[PA_UI_ELEMENT_BUTTON_TOOL_MODE_COMPOSITE], pos_x, pos_y, pos_vx, pos_vy);
	pos_x += pos_vx;
	resize_element(uip->element[PA_UI_ELEMENT_BUTTON_TOOL_MODE_OUTLINE], pos_x, pos_y, pos_vx, pos_vy);
	pos_y += pos_vy + mt + mb;
	pos_x = t3f_default_view->width - right_pane_width + ml + mr + esl;
	...
	pos_x = esl;
	pos_y += s;
	resize_element(uip->element[PA_UI_ELEMENT_LEFT_SHADE_SLIDER], pos_x, pos_y, s, uip->theme->theme[PA_UI_THEME_SLIDER]->state[0].scrollbar_size);
	pos_x += s + esl;
	resize_element(uip->element[PA_UI_ELEMENT_RIGHT_SHADE_SLIDER], pos_x, pos_y, s, uip->theme->theme[PA_UI_THEME_SLIDER]->state[0].scrollbar_size);
	pos_x = esl;
	pos_y += uip->theme->theme[PA_UI_THEME_SLIDER]->state[0].scrollbar_size;
	resize_element(uip->element[PA_UI_ELEMENT_LEFT_ALPHA_SLIDER], pos_x, pos_y, s, uip->theme->theme[PA_UI_THEME_SLIDER]->state[0].scrollbar_size);
	pos_x += s + esl;
	resize_element(uip->element[PA_UI_ELEMENT_RIGHT_ALPHA_SLIDER], pos_x, pos_y, s, uip->theme->theme[PA_UI_THEME_SLIDER]->state[0].scrollbar_size);
	pos_x = esl;
...
static void add_toolbar(PA_UI * uip, PA_CANVAS_EDITOR * cep)
{
	...
	uip->element[PA_UI_ELEMENT_TOOLBAR] = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_TOP_PANE], t3gui_box_proc, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL);
	...
	uip->element[PA_UI_ELEMENT_TOOLBAR_FILE_SEPARATOR] = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_SEPARATOR], t3gui_box_proc, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL);
	...
	uip->element[PA_UI_ELEMENT_TOOLBAR_UNDO_SEPARATOR] = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_SEPARATOR], t3gui_box_proc, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL);
	...
	uip->element[PA_UI_ELEMENT_TOOLBAR_CLIPBOARD_SEPARATOR] = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_SEPARATOR], t3gui_box_proc, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL);
...
static void add_right_pane(PA_UI * uip, PA_CANVAS_EDITOR * cep)
{
	...
	uip->element[PA_UI_ELEMENT_LAYER_LIST] = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_LIST_BOX], pa_list_proc, 0, 0, 0, 0, 0, D_SETFOCUS, 0, 0, pa_layer_list_proc, NULL, cep);
...
{
	uip->element[PA_UI_ELEMENT_LEFT_PANE] = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_LEFT_PANE], t3gui_box_proc, 0, 0, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL);
	...
	cep->left_color.shade_slider_element = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_SLIDER], t3gui_slider_proc, 0, 0, 0, 0, 0, 0, 1000, 0, NULL, NULL, NULL);
	uip->element[PA_UI_ELEMENT_LEFT_SHADE_SLIDER] = cep->left_color.shade_slider_element;
	cep->right_color.shade_slider_element = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_SLIDER], t3gui_slider_proc, 0, 0, 0, 0, 0, 0, 1000, 0, NULL, NULL, NULL);
	uip->element[PA_UI_ELEMENT_RIGHT_SHADE_SLIDER] = cep->right_color.shade_slider_element;
	cep->left_color.alpha_slider_element = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_SLIDER], t3gui_slider_proc, 0, 0, 0, 0, 0, 0, 1000, 0, NULL, NULL, NULL);
	uip->element[PA_UI_ELEMENT_LEFT_ALPHA_SLIDER] = cep->left_color.alpha_slider_element;
	cep->right_color.alpha_slider_element = t3gui_dialog_add_element(uip->dialog[PA_UI_DIALOG_MAIN], uip->theme->theme[PA_UI_THEME_SLIDER], t3gui_slider_proc, 0, 0, 0, 0, 0, 0, 1000, 0, NULL, NULL, NULL);
...
void pa_process_ui(PA_UI * uip)
{
	...
	{
		uip->color_popup_dialog = pa_create_color_editor_popup_dialog(&cep->left_color.color, uip->theme);
